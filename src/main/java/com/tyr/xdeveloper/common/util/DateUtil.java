package com.tyr.xdeveloper.common.util;
...
public class DateUtil {
     ...
     * 日期格式 MMdd
     */
    public static final String FORMAT_STR12 = "MMdd";
     ...
     * 获取前几天或者后几天的时间信息
     *
     * @param i       天数，正数为后i天，负数为前i天
     * @param strDate 时间
     * @return date
     */
    public static String getYesterDayDate(int i, String strDate) {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        String putDates = null;
        try {
